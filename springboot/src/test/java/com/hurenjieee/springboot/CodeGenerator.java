...
public class CodeGenerator {
    ...
    // Config
    public static final String URL = "jdbc:mysql://localhost:3306/demo_2?useUnicode=true&useSSL=false&characterEncoding=utf8";
    ...
    public static final String PARENT_PATH = "com.hurenjieee.springboot";

    // Super Entity
    public static final String SUPER_ENTITY_CLASS = "";
    ...
    // Tables
    public static final String[] TABLES = new String[]{"author"};
